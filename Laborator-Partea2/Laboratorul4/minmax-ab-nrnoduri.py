...
def min_max(stare):
    ...
    contor += len(stare.mutari_posibile)  # modificare
...
def alpha_beta(alpha, beta, stare):
    global contor  # modificare
    global retezari  # contorii de noduri + retezari
...
def main():
    ...
    while True:
        ...
        # --------------------------------
            ...
            global retezari  # modificare
            retezari = 0  # modificare
            if tip_algoritm == '1':
                stare_actualizata = min_max(stare_curenta)
            else:  # tip_algoritm==2
                stare_actualizata = alpha_beta(-500, 500, stare_curenta)
            print("Noduri = " + str(contor))  # modificare
            print("Retezari = " + str(retezari))  # modificare
